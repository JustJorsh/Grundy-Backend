  ...
  async registerMerchant(req, res) {
    try {
      ...
      try {
        ...
        await merchant.save();
        console.log(
          'Paystack sub-account created successfully:',
    ...
    try {
      ...
      if (merchantId) {
        try {
          ...
          return res
            .status(400)
            .json({ success: false, error: 'Invalid merchantId' });
        }
      }
      ...
      if (typeof available !== 'undefined')
        prodMatch['products.available'] = available === 'true';
